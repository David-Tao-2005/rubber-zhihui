...
function ensureFieldServiceStyles() {
  ...
  style.textContent = `
    ...
    .partner-app-card{display:grid;gap:12px;padding:16px;border-radius:20px;background:linear-gradient(135deg,#075d49,#14a67e);color:#fff;box-shadow:0 13px 30px rgba(10,102,77,.18)}.partner-entry-photo{position:relative;width:100%;height:150px;padding:0;border:0;border-radius:14px;overflow:hidden;background:#0b4d3d;cursor:pointer;text-align:left}.partner-entry-photo img{width:100%;height:100%;display:block;object-fit:cover}.partner-entry-photo:after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,rgba(3,42,32,.68),rgba(3,42,32,.08) 72%)}.partner-entry-photo span{position:absolute;z-index:1;left:14px;bottom:12px;color:#fff;font-size:13px;font-weight:800;text-shadow:0 1px 3px #17362e}.partner-app-card h3{font-size:17px;margin:2px 0}.partner-app-card p:not(.eyebrow){margin:2px 0 0;font-size:12px;line-height:1.5;color:#e0f5ec}.partner-app-card .eyebrow{color:#bce8d8}.partner-open-button{border:0;border-radius:11px;background:#fff;color:#087154;padding:11px;font-weight:800;font:inherit}.partner-app-card small{color:#d7f2e7;font-size:10px;line-height:1.45}
...
function setupDiagnosis() {
  main.innerHTML = `
    ...
    <section class="partner-app-card">
      <button id="rubber-guard-image" class="partner-entry-photo" type="button" aria-label="打开橡胶卫士小程序入口"><img src="assets/rubber-guard-entry.png" alt="橡胶树割胶场景" /><span>点击打开橡胶卫士入口</span></button>
